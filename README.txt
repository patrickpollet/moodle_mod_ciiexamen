...
Rename the ciiexamen folder into a lower case name of your module. Make sure
...
instances of string "ciiexamen" to your new module name (eg "widget").
   
Rename the file lang/en_utf8/ciiexamen.php to widget.php or whatever your
module name is.
...
should find that this ciiexamen has been added to the list of recognized
modules.  
...
Credits for work on this ciiexamen template
-------------------------------------------
